...
yearly_input <- layer_input(shape = list(4,6), name = "yearly_input")
yearly_NN <- yearly_input %>% 
  layer_simple_rnn(units = 32)

monthly_input <- layer_input(shape = list(24,12), name = "monthly_input")
monthly_NN <- monthly_input %>% 
  layer_lstm(units = 32)

other_input <- layer_input(shape = list(6))
...
keras_model(inputs = list(yearly_input, monthly_input, other_input), output)
