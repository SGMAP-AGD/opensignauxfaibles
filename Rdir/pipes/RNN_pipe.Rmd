...
table_wholesample <- table_wholesample %>% 
  objective_default_or_failure(table_wholesample,n_months = 3, threshold = 1, lookback = 24) %>%
...
# NON ne faire que sur l'échantillon d'entraînement. 
table_wholesample_scaled <- table_wholesample %>%
...
#other_input <- layer_input(shape = list(4))
