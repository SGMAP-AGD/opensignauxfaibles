...
```{r}
raw_data <- connect_to_database('algo1')
```
...
other_input <- layer_input(shape = list(1))


concatenated <- layer_concatenate(list(yearly_NN,monthly_NN,other_input))
...
```{r}
# FIX ME 
# Ne pas prendre les imputed data
