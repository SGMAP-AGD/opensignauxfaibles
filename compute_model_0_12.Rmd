...
output_prediction_0_12 %>%
  ...
  dplyr::slice(1:100) %>%
  write.table(row.names=F, dec=',', sep=';', file = "output/table_predictions_2018_02_22v4.csv", quote=T, append=F)
```
...
output_prediction_0_12 %>%
  ...
  dplyr::slice(1:100) %>%
  write.table(row.names=F, dec=',', sep=';', file = "output/table_predictions_2018_02_22v4_im.csv", quote=T, append=F)
```
...
output_prediction_0_12 %>%
  ...
  dplyr::filter(is.na(prediction_0_12) == FALSE) %>%
  write.table(row.names=F, dec=',', sep=';', file = "output/table_predictions_2018_02_22v4_all.csv", quote=T, append=F)
```
