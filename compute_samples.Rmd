...
## Banque de France
```{r}
compute_wholesample_banquedefrance(
  db = database_signauxfaibles,
  name = "wholesample_banquedefrance"
)
...
```{r}
write.table(wholesample, row.names=F, dec=',', sep=';', file = "output/wholesample.csv", quote=T, append=F)
