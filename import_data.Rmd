...
table_apart_heuresconsommees1 <- import_apart_heuresconsommees(
...
table_apart_heuresconsommees2 <- import_apart_heuresconsommees(
...
table_apart_heuresconsommees3 <- import_apart_heuresconsommees(
...
bind_rows(table_apart_heuresconsommees1, table_apart_heuresconsommees2, table_apart_heuresconsommees3) %>%
  dplyr::distinct() %>%
  copy_to(dest = database_signauxfaibles, df = ., name = "table_apart_consommee", temporary = FALSE)
```
