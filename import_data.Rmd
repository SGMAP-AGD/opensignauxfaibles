...
dplyr::bind_rows(
  import_table_activite_partielle(
    path = "data-raw/activite_partielle/act_partielle_ddes_2012_janv2018.xlsx",
    hta = "hta",
    mta = "mta",
...
db_drop_table_ifexist(db = database_signauxfaibles, table = "table_apart_consommee")
  ...
  import_apart_heuresconsommees(
    path = "data-raw/activite_partielle/act_partielle_conso_janv2018.xlsx",
    sheet = "INDEMNITE",
    skip = 0,
    date = "mois",
...
import_table_effectif2(
  path = "data-raw/effectif/Urssaf_emploi_BFC_201001_201709.csv"
  ) %>%
  insert_multi(
    dest = database_signauxfaibles,
    df = .,
